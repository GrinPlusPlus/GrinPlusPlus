...
class Transaction
{
  public:
    ...
    inline bool operator<(const Transaction &transaction) const
    {
        return GetHash() < transaction.GetHash();
    }
    inline bool operator==(const Transaction &transaction) const
    {
        return GetHash() == transaction.GetHash();
    ...
    // Getters
    //
    inline const BlindingFactor &GetOffset() const
    {
        return m_offset;
    }
    inline const TransactionBody &GetBody() const
    {
