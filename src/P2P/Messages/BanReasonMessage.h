...
class BanReasonMessage : public IMessage
{
  public:
    ...
    // Constructors
    //
    BanReasonMessage(const uint32_t banReason) : m_banReason(banReason)
    {
    }
    ...
    // Clone
    //
    virtual BanReasonMessage *Clone() const override final
    {
        return new BanReasonMessage(*this);
    }
    ...
    {
        return MessageTypes::BanReasonMsg;
    }
    inline const uint32_t GetBanReason() const
    {
        return m_banReason;
    }
