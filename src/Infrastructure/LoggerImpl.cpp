...
void Logger::StartLogger(const std::string &directory, const spdlog::level::level_enum &logLevel)
{
    ...
    m_pLogger = spdlog::create_async("LOGGER", sink, 8192, spdlog::async_overflow_policy::block_retry, nullptr,
