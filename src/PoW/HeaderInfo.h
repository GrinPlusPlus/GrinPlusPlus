...
{
  public:
    HeaderInfo(const uint64_t timestamp, const uint64_t difficulty, const uint32_t secondaryScaling,
    ...
    inline uint64_t GetDifficulty() const
    {
        return m_difficulty;
    }
    inline uint32_t GetSecondaryScaling() const
    {
