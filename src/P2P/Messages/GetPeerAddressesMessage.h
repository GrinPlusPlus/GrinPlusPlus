...
class GetPeerAddressesMessage : public IMessage
{
  public:
    ...
    // Constructors
    //
    GetPeerAddressesMessage(const Capabilities &capabilities) : m_capabilities(capabilities)
    {
    }
    ...
    // Clone
    //
    virtual GetPeerAddressesMessage *Clone() const override final
    {
        return new GetPeerAddressesMessage(*this);
    }
    ...
    {
        return MessageTypes::GetPeerAddrs;
    }
