...
{
  public:
    ProofMessage(CBigInteger<20> &&proofMessageBytes) : m_proofMessageBytes(proofMessageBytes)
    {
    }
    ...
    inline const CBigInteger<20> &GetBytes() const
    {
        return m_proofMessageBytes;
    }
