...
{
  public:
    static void AddHashes(HashFile &hashFile, const std::vector<unsigned char> &serializedLeaf,
    ...
    static std::vector<Hash> GetLastLeafHashes(const HashFile &hashFile, const LeafSet *pLeafSet,
