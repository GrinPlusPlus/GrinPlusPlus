...
class CompactBlockMessage : public IMessage
{
  public:
    ...
    // Constructors
    //
    CompactBlockMessage(CompactBlock &&block) : m_block(std::move(block))
    {
    }
    CompactBlockMessage(const CompactBlock &block) : m_block(block)
    {
    }
    ...
    // Clone
    //
    virtual CompactBlockMessage *Clone() const override final
    {
        return new CompactBlockMessage(*this);
    }
    ...
    {
        return MessageTypes::CompactBlockMsg;
    }
    inline const CompactBlock &GetCompactBlock() const
    {
        return m_block;
    }
