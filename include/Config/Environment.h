...
{
public:
	Environment(const FullBlock& block, const uint32_t publicKeyVersion, const uint32_t privateKeyVersion)
		: m_block(std::move(block)), m_publicKeyVersion(publicKeyVersion), m_privateKeyVersion(privateKeyVersion)
	{
