...
{
  public:
    template <typename Collection, typename unop> static void for_each(Collection col, unop op)
    {
    ...
    template <typename Collection, typename Predicate> static Collection filterNot(Collection col, Predicate predicate)
    {
    ...
    template <typename Collection, typename Predicate> static Collection filter(Collection col, Predicate predicate)
    {
