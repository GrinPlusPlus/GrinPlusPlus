...
class GetTransactionMessage : public IMessage
{
  public:
    ...
    // Constructors
    //
    GetTransactionMessage(Hash &&kernelHash) : m_kernelHash(std::move(kernelHash))
    {
    }
    GetTransactionMessage(const Hash &kernelHash) : m_kernelHash(kernelHash)
    {
    }
    ...
    // Clone
    //
    virtual GetTransactionMessage *Clone() const override final
    {
        return new GetTransactionMessage(*this);
    }
    ...
    {
        return MessageTypes::GetTransactionMsg;
    }
