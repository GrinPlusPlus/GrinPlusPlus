...
class RewoundProof
{
  public:
    ...
    inline const std::unique_ptr<SecretKey> &GetBlindingFactor() const
    {
        return m_pBlindingFactor;
    }
    inline const ProofMessage &GetProofMessage() const
    {
        return m_proofMessage;
    }
