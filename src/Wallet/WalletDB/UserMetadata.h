...
class UserMetadata
{
  public:
    ...
    inline uint32_t GetNextTxId() const
    {
        return m_nextTxId;
    }
    inline uint64_t GetRefreshBlockHeight() const
    {
        return m_refreshBlockHeight;
    }
    inline uint64_t GetRestoreLeafIndex() const
    {
        return m_restoreLeafIndex;
    }
