...
/*
    ...
    mg_set_request_handler(ctx, "/v1/chain/outputs/byheight", ChainAPI::GetChainOutputsByHeight_Handler,
   &m_nodeContext); mg_set_request_handler(ctx, "/v1/chain", ChainAPI::GetChain_Handler, m_pBlockChainServer);
    ...
    mg_set_request_handler(ctx, "/v1/txhashset/lastrangeproofs", TxHashSetAPI::GetLastRangeproofs_Handler,
   &m_nodeContext); mg_set_request_handler(ctx, "/v1/txhashset/outputs", TxHashSetAPI::GetOutputs_Handler,
   &m_nodeContext); mg_set_request_handler(ctx, "/v1/", ServerAPI::V1_Handler, &m_nodeContext);
*/
