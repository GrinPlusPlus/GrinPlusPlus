...
class BlockHeader
{
  public:
    ...
    // Constructors
    //
    BlockHeader(const uint16_t version, const uint64_t height, const int64_t timestamp, Hash &&previousBlockHash,
                Hash &&previousRoot, Hash &&outputRoot, Hash &&rangeProofRoot, Hash &&kernelRoot,
    ...
    inline const Hash &GetPreviousBlockHash() const
    {
        return m_previousBlockHash;
    }
    inline const Hash &GetPreviousRoot() const
    {
        return m_previousRoot;
    }
    ...
    inline uint32_t GetScalingDifficulty() const
    {
        return m_scalingDifficulty;
    }
    inline uint64_t GetNonce() const
    {
        return m_nonce;
    }
    inline const ProofOfWork &GetProofOfWork() const
    {
        return m_proofOfWork;
    }

    // Merklish roots
    inline const Hash &GetOutputRoot() const
    {
        return m_outputRoot;
    }
    inline const Hash &GetRangeProofRoot() const
    {
        return m_rangeProofRoot;
    }
    inline const Hash &GetKernelRoot() const
    {
        return m_kernelRoot;
    }

    inline const BlindingFactor &GetTotalKernelOffset() const
    {
        return m_totalKernelOffset;
    }

    // Merkle Mountain Range Sizes
    inline uint64_t GetOutputMMRSize() const
    {
        return m_outputMMRSize;
    }
    inline uint64_t GetKernelMMRSize() const
    {
    ...
    {
        return m_proofOfWork.GetHash();
    }
    inline const std::string FormatHash() const
    {
        return HexUtil::ConvertHash(GetHash());
    }
