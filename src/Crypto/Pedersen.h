...
class Pedersen
{
  public:
    ...
    std::unique_ptr<Commitment> PedersenCommitSum(const std::vector<Commitment> &positive,
                                                  const std::vector<Commitment> &negative) const;
    std::unique_ptr<BlindingFactor> PedersenBlindSum(const std::vector<BlindingFactor> &positive,
    ...
    static std::vector<secp256k1_pedersen_commitment *> ConvertCommitments(const secp256k1_context &context,
