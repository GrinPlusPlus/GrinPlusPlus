...
class ConnectedPeer
{
  public:
    ...
    ConnectedPeer(const ConnectedPeer &peer)
        : m_peer(peer.m_peer), m_direction(peer.m_direction), m_height(peer.m_height.load()),
          m_totalDifficulty(peer.m_totalDifficulty.load())
    {
    }
