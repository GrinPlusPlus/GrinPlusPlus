...
std::vector<unsigned char> WalletEncryptionUtil::Encrypt(const SecureVector &masterSeed, const std::string &dataType,
...
SecureVector WalletEncryptionUtil::Decrypt(const SecureVector &masterSeed, const std::string &dataType,
