...
public:
	...
	bool Restore(const SecretKey& masterSeed, Wallet& wallet) const;
...
private:
	...
	bool SaveWalletOutputs(const SecretKey& masterSeed, Wallet& wallet, const std::vector<OutputData>& outputs) const;
