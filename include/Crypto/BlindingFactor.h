...
class BlindingFactor
{
  public:
    ...
    // Constructors
    //
    BlindingFactor(Hash &&blindingFactorBytes) : m_blindingFactorBytes(std::move(blindingFactorBytes))
    {
    }
    BlindingFactor(const Hash &blindingFactorBytes) : m_blindingFactorBytes(blindingFactorBytes)
    {
    }
    ...
    inline bool operator<(const BlindingFactor &rhs) const
    {
        return m_blindingFactorBytes < rhs.GetBytes();
    }
    inline bool operator!=(const BlindingFactor &rhs) const
    {
        return m_blindingFactorBytes != rhs.GetBytes();
    ...
    // Getters
    //
    inline const CBigInteger<32> &GetBytes() const
    {
        return m_blindingFactorBytes;
    }
