...
class TransactionInput
{
  public:
    ...
    inline bool operator<(const TransactionInput &transactionInput) const
    {
        return GetCommitment() < transactionInput.GetCommitment();
    }
    inline bool operator==(const TransactionInput &transactionInput) const
    {
        return GetHash() == transactionInput.GetHash();
    }
