...
class Request
{
  public:
    ...
    inline const Json::Value &GetId() const
    {
        return m_id;
    }
    ...
    inline const std::optional<Json::Value> &GetParams() const
    {
        return m_paramsOpt;
    }
...
class Error
{
  public:
    ...
    inline const std::optional<Json::Value> &GetData() const
    {
        return m_data;
    }
...
class Response
{
  public:
    ...
    static Response BuildError(const Json::Value &id, const int code, const std::string &message,
                               const std::optional<Json::Value> &data)
    {
    ...
    inline const std::optional<Json::Value> &GetResult() const
    {
        return m_resultOpt;
    }
    inline const std::optional<Error> &GetError() const
    {
        return m_errorOpt;
    }
