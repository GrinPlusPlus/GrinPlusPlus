...
class TxHashSetArchiveMessage : public IMessage
{
  public:
    ...
    // Clone
    //
    virtual TxHashSetArchiveMessage *Clone() const override final
    {
        return new TxHashSetArchiveMessage(*this);
    }
    ...
    {
        return MessageTypes::TxHashSetArchive;
    }
    inline const Hash &GetBlockHash() const
    {
        return m_blockHash;
    }
    ...
    inline uint64_t GetZippedSize() const
    {
        return m_zippedDataSize;
    }
