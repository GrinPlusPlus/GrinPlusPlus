...
class SlateContext
{
  public:
    ...
    inline const SecretKey &GetSecretKey() const
    {
        return m_secretKey;
    }
    inline const SecretKey &GetSecretNonce() const
    {
        return m_secretNonce;
    }
    ...
    static SlateContext Decrypt(const std::vector<unsigned char> &encrypted, const SecureVector &masterSeed,
